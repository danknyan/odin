...
# Dan Rishea
**Data Scientist & Applied AI/NLP Engineer**

[rishea.dan@gmail.com](mailto:rishea.dan@gmail.com) • [linkedin.com/in/danrishea-6507b3120](https://www.linkedin.com/in/danrishea-6507b3120)

---

## Summary

Data scientist and applied AI engineer who turns fragmented, real-world data into decisions from predictive modeling of educational outcomes in Indonesia, to NLP content-validation systems in Japan, to a current end-to-end pipeline for hierarchical topic modeling of global news. Comfortable owning both the technical build and the stakeholder management that makes findings usable.

---

## Technical Skills

**Languages & Modeling:** Python, SQL, Pandas, Scikit-learn, PyTorch, predictive modeling, topic modeling & clustering, LLM-based text labeling

**Visualization & Tools:** Tableau, Plotly, Seaborn, Matplotlib, Jupyter Notebooks, Google Workspace, Salesforce
...
### Global News Lens — NLP Capstone (ODAT5708)
*2026*

- Built an end-to-end pipeline applying hierarchical topic modeling and large language models to surface how global news themes evolve across regions, deployed as an interactive dashboard.

---

## Education

**Master of Engineering (MEng), Data Science** | University of Sydney
*Feb 2024 – Sep 2026 (in progress)*

**Bachelor's Degree, Linguistics** | McMaster University
*2005 – 2010*
